...
final class VideoMerger: NSObject {
    ...
    func compositeVideo(fromVideoUrls videoUrls: [URL], videoSize: CGSize, exportQuality: VideoExportQuality)-> (asset: AVMutableComposition?, videoComposition: AVMutableVideoComposition?) {
        ...
        for url in videoUrls {
            ...
            do {
                try compositeVideoTrack.insertTimeRange(CMTimeRangeMake(start: CMTime.zero, duration: videoAssetTrack.timeRange.duration), of: videoAssetTrack, at: totalDuration)
                try compositeAudioTrack.insertTimeRange(CMTimeRangeMake(start: CMTime.zero, duration: audioAssetTrack.timeRange.duration), of: audioAssetTrack, at: totalDuration)
