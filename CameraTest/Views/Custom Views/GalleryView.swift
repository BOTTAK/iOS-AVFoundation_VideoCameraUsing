...
//        addConstraints([leadingConstraint, trailingConstraint, topConstraint])
        ...
        collectionView.register(UINib(nibName: "GalleryCollectionFooterView", bundle: nil), forSupplementaryViewOfKind: UICollectionView.elementKindSectionFooter, withReuseIdentifier: "GalleryCollectionFooterView")
...
extension GalleryView: UICollectionViewDataSource, UICollectionViewDelegate {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.didDeleteAssetBlock = { [weak self] (index) in
            let alertController = UIAlertController(title: "Delete?", message: "Do you want to discard this clip?", preferredStyle: UIAlertController.Style.alert)
            
            alertController.addAction(UIAlertAction(title: "Cancel", style: UIAlertAction.Style.default))
            
            alertController.addAction(UIAlertAction(title: "Delete", style: UIAlertAction.Style.destructive, handler: { [weak self] (action) in
